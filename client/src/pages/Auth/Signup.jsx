        ...
        <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center px-4 py-8">
            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="mt-4 text-2xl md:text-3xl font-bold text-gray-800">Create Account</h1>
                    <p className="mt-2 text-sm text-gray-600">Join the e-Voting platform</p>
                </div>
                ...
                <div className="bg-white/70 backdrop-blur-lg rounded-2xl p-6 md:p-8 shadow-xl border border-white/20">
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-600">
                            ...
                            <Link to="/login" className="ml-1 text-indigo-600 hover:text-indigo-700 font-medium hover:underline transition-colors duration-200">
                                Sign In
                            </Link>
                        </p>
                    </div>
